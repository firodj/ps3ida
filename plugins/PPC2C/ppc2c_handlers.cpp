...
void handle_std(Function &func, Instruction &ins, HandlerResult *result) {
    ...
    result->c_code =
        string(result->out_reg) + "[" + tostr(offset) + "] = " + string(result->in_reg1);
}
...
void handle_lbz(Function &func, Instruction &ins, HandlerResult *result) {
    ...
    result->c_code = string(result->out_reg) + " = ((uint8_t *)" + string(result->in_reg1) + ")[" +
                     tostr(offset) + "]";
}
...
void handle_add(Function &func, Instruction &ins, HandlerResult *result) {
    ...
    result->c_code =
        string(result->out_reg) + " = " + string(result->in_reg1) + " + " + string(result->in_reg2);
}
...
void handle_addi(Function &func, Instruction &ins, HandlerResult *result) {
    ...
    result->c_code =
        string(result->out_reg) + " = " + string(result->in_reg1) + " + " + ins.operands[2];
}
